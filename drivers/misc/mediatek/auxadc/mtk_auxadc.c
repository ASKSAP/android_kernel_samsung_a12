...
static int IMM_GetOneChannelValue_Cali_mV(int Channel, int *voltage);

#define MT6765_AUXADC_CHANNEL(idx) {				    \
		.type = IIO_VOLTAGE,				    \
		.indexed = 1,					    \
		.channel = (idx),				    \
...
static const struct iio_chan_spec mt6765_auxadc_iio_channels[] = {
	MT6765_AUXADC_CHANNEL(0),
	MT6765_AUXADC_CHANNEL(1),
	MT6765_AUXADC_CHANNEL(2),
	MT6765_AUXADC_CHANNEL(3),
	MT6765_AUXADC_CHANNEL(4),
	MT6765_AUXADC_CHANNEL(5),
	MT6765_AUXADC_CHANNEL(6),
	MT6765_AUXADC_CHANNEL(7),
	MT6765_AUXADC_CHANNEL(8),
	MT6765_AUXADC_CHANNEL(9),
	MT6765_AUXADC_CHANNEL(10),
	MT6765_AUXADC_CHANNEL(11),
	MT6765_AUXADC_CHANNEL(12),
	MT6765_AUXADC_CHANNEL(13),
	MT6765_AUXADC_CHANNEL(14),
	MT6765_AUXADC_CHANNEL(15),
};

static int mt6765_auxadc_read_raw(struct iio_dev *indio_dev,
				  ...
				  long info)
{
	...
	case IIO_CHAN_INFO_PROCESSED:
		ret = IMM_GetOneChannelValue_Cali_mV(chan->channel, val);
		if (ret < 0) {
			dev_notice(indio_dev->dev.parent,
				"failed to sample data on channel[%d]\n",
				chan->channel);
...
static const struct iio_info mt6765_auxadc_info = {
	.read_raw = &mt6765_auxadc_read_raw,
};
#endif
 ...
 */
int IMM_GetOneChannelValue_Cali_mV(int Channel, int *voltage)
{
	int ret = 0;

	ret = IMM_auxadc_GetOneChannelValue_Cali(Channel, voltage);
...
static int mt_auxadc_probe(struct platform_device *dev)
{
	...
	indio_dev->info = &mt6765_auxadc_info;
	indio_dev->modes = INDIO_DIRECT_MODE;
	indio_dev->channels = mt6765_auxadc_iio_channels;
	indio_dev->num_channels = ARRAY_SIZE(mt6765_auxadc_iio_channels);

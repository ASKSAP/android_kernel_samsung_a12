...
#define IMGSENSOR_REAR_MAX_CAL_SIZE    (0x230F + 0x1)

#define REAR_HEADER_CHECKSUM_LEN     (0x00FB - 0x0000 + 0x1)
#define REAR_OEM_CHECKSUM_LEN        (0x017B - 0x0100 + 0x1)
#define REAR_AWB_CHECKSUM_LEN        (0x1E6B - 0x1E60 + 0x1)
#define REAR_SHADING_CHECKSUM_LEN    (0x226B - 0x1E70 + 0x1)
...
#define REAR_CONVERTED_MAX_CAL_SIZE (0x266F + 0x1)
#define REAR_CONVERTED_AWB_CHECKSUM_LEN (0x1E6B - 0x1E60 + 0x1)
#define REAR_CONVERTED_LSC_CHECKSUM_LEN (0x25CB - 0x1E70 + 0x1)

const struct rom_converted_cal_addr rear_2p6_converted_cal_addr = {
	.rom_awb_cal_data_start_addr = 0x1E60,
	.rom_awb_checksum_addr = 0x1E6C,
	.rom_awb_checksum_len = (REAR_CONVERTED_AWB_CHECKSUM_LEN),
	.rom_shading_cal_data_start_addr = 0x1E70,
	.rom_shading_checksum_addr = 0x25CC,
	.rom_shading_checksum_len = (REAR_CONVERTED_LSC_CHECKSUM_LEN),
};

const struct imgsensor_vendor_rom_addr rear_2p6_cal_addr = {
	/* Set '-1' if not used */
	...
	.rom_shading_checksum_addr              = 0x226C,
	...
	.rom_pdaf_module_info_start_addr        = 0x09A0,
	...
	.converted_cal_addr                     = &rear_2p6_converted_cal_addr,

...
#ifdef DEBUG_MUIC
	sm5714_reg_log(command, ret, retry << 1 | READ);
#endif
	return ret;
}
...
{
	struct sm5714_muic_data *muic_data = dev_get_drvdata(dev);
	int vol = sm5714_muic_get_vbus_value(muic_data);
...
#endif
static DEVICE_ATTR(usb_state, 0664, sm5714_muic_show_usb_state, NULL);
#if defined(CONFIG_USB_HOST_NOTIFY)
static DEVICE_ATTR(otg_test, 0664,
		sm5714_muic_show_otg_test, sm5714_muic_set_otg_test);
#endif
static DEVICE_ATTR(attached_dev, 0664, sm5714_muic_show_attached_dev, NULL);

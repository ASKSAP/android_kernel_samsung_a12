...
int mtk_pinmux_get(struct gpio_chip *chip, unsigned int offset);
int mtk_gpio_get_direction(struct gpio_chip *chip, unsigned int offset);
int mtk_gpio_get_in(struct gpio_chip *chip, unsigned int offset);
int mtk_gpio_get_out(struct gpio_chip *chip, unsigned int offset);
int mtk_pullen_get(struct gpio_chip *chip, unsigned int offset);
int mtk_pullsel_get(struct gpio_chip *chip, unsigned int offset);

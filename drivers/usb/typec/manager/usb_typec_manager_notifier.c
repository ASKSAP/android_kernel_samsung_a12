...
#if defined(CONFIG_SEC_FACTORY)
static ssize_t tyepc_manager_fac_usb_control(struct device *dev,
...
static DEVICE_ATTR(fac_usb_control, 0220, NULL, tyepc_manager_fac_usb_control);
...
#if defined(CONFIG_HICCUP_CHARGER) && IS_ENABLED(CONFIG_BATTERY_SAMSUNG)
